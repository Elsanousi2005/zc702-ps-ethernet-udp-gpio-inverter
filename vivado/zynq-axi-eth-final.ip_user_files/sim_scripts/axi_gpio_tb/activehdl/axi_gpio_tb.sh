...
#                script (type 'axi_gpio_tb.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/elsan/vs_workspace/zynq-axi-eth-final/zynq-axi-eth-final.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
