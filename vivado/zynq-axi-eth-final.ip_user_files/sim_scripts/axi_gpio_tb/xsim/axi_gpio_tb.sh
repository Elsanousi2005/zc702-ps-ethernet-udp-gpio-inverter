...
#
# Script generated by Vivado on Fri Jan 09 18:04:07 -0500 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_gpio_tb.sh
...
#
# Usage        : axi_gpio_tb.sh
#                axi_gpio_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_gpio_tb.sh [-rerun]
#                axi_gpio_tb.sh [-reset_run]
#                axi_gpio_tb.sh [-clean]
#                axi_gpio_tb.sh [-reset_log]
#                axi_gpio_tb.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax -L xilinx_vip -L uvm -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L xilinx_vip"
...
# script info
echo -e "axi_gpio_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_gpio_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2 -L xilinx_vip -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L util_vector_logic_v2_0_5 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_gpio_tb xil_defaultlib.axi_gpio_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_gpio_tb -key {Behavioral:sim_1:Functional:axi_gpio_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_7a78.protoinst" -protoinst "protoinst_files/axi_gpio_tb.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_gpio_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_gpio_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_gpio_tb.sh [-help]\n\
Usage: axi_gpio_tb.sh [-step]\n\
Usage: axi_gpio_tb.sh [-lib_map_path]\n\
Usage: axi_gpio_tb.sh [-rerun]\n\
Usage: axi_gpio_tb.sh [-reset_run]\n\
Usage: axi_gpio_tb.sh [-clean]\n\
Usage: axi_gpio_tb.sh [-reset_log]\n\
Usage: axi_gpio_tb.sh [-keep_index]\n\
Usage: axi_gpio_tb.sh [-noclean_files]\n\n\
