...
#
# Script generated by Vivado on Fri Jan 09 16:57:53 -0500 2026
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_7a78.protoinst" -protoinst "protoinst_files/axi_gpio_tb.protoinst" -log simulate.log
}
